...
class Keywords(models.Model):
    ...
    DATECREATED = models.DateTimeField('创建时间',null=True)
    DATEMODIFED = models.DateTimeField('修改时间',null=True)
    DELETED = models.BooleanField('是否删除', default=True,blank =True)
    ENTITY_NAME = models.CharField('实体名', max_length=255,null=True)
...
class Seeds(models.Model):
    ...
    DATECREATED = models.DateTimeField('创建时间')
    DATEMODIFED = models.DateTimeField('修改时间')
    DELETED = models.BooleanField('是否删除', default=True)
    ENTITY_NAME = models.CharField('实体名', max_length=255)
